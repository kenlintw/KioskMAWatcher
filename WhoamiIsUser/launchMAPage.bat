...
echo [%date% %time%] Task started >> C:\Users\User\Documents\scripts\launchMAPage.log

"C:\ITKiosk\Tool\KillMainApModule.exe" >> C:\Users\User\Documents\scripts\launchMAPage.log 2>&1
