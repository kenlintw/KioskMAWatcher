...
echo [%date% %time%] Task started >> C:\Users\admin\Documents\scripts\launchMAPage.log

"C:\ITKiosk\Tool\KillMainApModule.exe" >> C:\Users\admin\Documents\scripts\launchMAPage.log 2>&1
